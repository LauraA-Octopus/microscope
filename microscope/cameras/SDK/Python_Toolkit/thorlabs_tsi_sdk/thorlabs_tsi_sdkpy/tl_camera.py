...
from microscope.cameras.SDK.Python_Toolkit.thorlabs_tsi_sdk.thorlabs_tsi_sdkpy.tl_camera_enums import EEP_STATUS, DATA_RATE, SENSOR_TYPE, OPERATION_MODE, COMMUNICATION_INTERFACE, \
    USB_PORT_TYPE, TRIGGER_POLARITY, TAPS
from microscope.cameras.SDK.Python_Toolkit.thorlabs_tsi_sdk.thorlabs_tsi_sdkpy.tl_color_enums import FILTER_ARRAY_PHASE
from microscope.cameras.SDK.Python_Toolkit.thorlabs_tsi_sdk.thorlabs_tsi_sdkpy.tl_polarization_enums import POLAR_PHASE
    ...
    def __init__(self):
        ...
        try:
            if platform.system() == 'Windows':
                self._sdk = cdll.LoadLibrary(r"C:\\Documents\\microscope\\microscope\\cameras\\SDK\\Python_Toolkit\\thorlabs_tsi_camera_sdk\\dll\\64_bits\\thorlabs_tsi_camera_sdk.dll")
...
class TLCameraError(Exception):
    def __init__(self, message):
        _logger.exception(f"TLCameraError: {message}")
