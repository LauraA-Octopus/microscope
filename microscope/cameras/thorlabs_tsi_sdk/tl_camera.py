...
from microscope.cameras.thorlabs_tsi_sdk.tl_camera_enums import EEP_STATUS, DATA_RATE, SENSOR_TYPE, OPERATION_MODE, COMMUNICATION_INTERFACE, \
    USB_PORT_TYPE, TRIGGER_POLARITY, TAPS
from microscope.cameras.thorlabs_tsi_sdk.tl_color_enums import FILTER_ARRAY_PHASE
from microscope.cameras.thorlabs_tsi_sdk.tl_polarization_enums import POLAR_PHASE
